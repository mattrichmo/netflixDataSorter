...
const inputPath = './data/clean/cleanDataFilmCombined.jsonl';

const outputFilePath = {
    jsonl: './data/flat/cleanDataFilmFlatCombined.jsonl',
    csv: './data/flat/cleanDataFilmFlatCombined.csv',
    xls: './data/flat/cleanDataFilmFlatCombined.xlsx',
};
